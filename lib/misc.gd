...
##  <ManSection>
##  <Meth Name="MonomialsOverField" Arg='F, poly'
##    Label="for a monomial - for an NLFSR"/>
##  <Meth Name="MonomialsOverField" Arg='F, mlist'
##  Label="for list of monomials - for an NLFSR"/>
